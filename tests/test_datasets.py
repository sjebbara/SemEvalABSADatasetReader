...
def test_semeval2014():
    parsed_dataset = read_semeval2014("res/semeval2014.xml", aspect_terms=True, aspect_categories=True)

    r1 = Review(review_id="Review_1",
                sentences=[
    ...
    target_dataset = Dataset([r1], dataset_format=DatasetFormat.SemEval2014)
